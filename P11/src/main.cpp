...
#include "point_types.cpp"
#include "point_set.hpp"
#include "point_set.cpp"
#include "subtree.hpp"
#include "subtree.cpp"
 ...
 */
Kruskal::point_vector ReadFile(std::ifstream& input_file) {
  std::string text_line;
  Kruskal::point_vector vector_of_points;
  std::getline(input_file, text_line);
  ...
  while (!text_line.empty()) {
    ...
    Kruskal::point new_point = std::pair<double, double>(coord_i, coord_j);
